  ...
  return (
    <section className="relative overflow-hidden bg-navy-deep">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 px-6 pb-14 pt-4 md:grid-cols-2 md:gap-6 md:pb-24 md:pt-8">
        {/* painel de texto */}
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-gold ring-1 ring-white/15 backdrop-blur">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            ...
            <a
              href="https://wa.me/5519323243660?text=Ol%C3%A1!%20Vim%20pela%20p%C3%A1gina%20de%20Matr%C3%ADculas%20e%20quero%20agendar%20uma%20visita."
              target="_blank"
        ...
        <div className="relative mx-auto w-full max-w-sm md:max-w-md">
          <div className="absolute inset-x-6 inset-y-10 rounded-full bg-gradient-to-br from-gold/25 via-skyblue/15 to-red/20 blur-3xl" />
      ...
      >
        <div className="rounded-3xl bg-white p-6 shadow-2xl sm:p-8">
          ...
          <div className="mt-5">
            <LeadForm id="hero-form" defaultSegment="infantil" />
          </div>
        </div>
      </div>
